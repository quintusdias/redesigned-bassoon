...
def setField(fp, tag, value):
    ...
    if tag_num == 320:
        ...
        args = [ctypes.POINTER(ctypes.c_voidp) for _ in range(value.shape[1])]
    ...
    if tag_num == 284 and value == lib.PlanarConfig.SEPARATE:
        ...
        pargs = [col.ctypes.data_as(ctypes.c_voidp) for col in columns]
        _LIBTIFF.TIFFSetField(fp, tag_num, *pargs)
